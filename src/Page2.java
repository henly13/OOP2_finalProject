...
public class Page2 {
	...
	public JPanel createItem()
	{
		...
		panel_label.add(new JLabel("   "));panel_label.add(new JLabel("8:00A.M."));panel_label.add(new JLabel("9:00A.M."));panel_label.add(new JLabel("10:00A.M."));panel_label.add(new JLabel("11:00A.M."));panel_label.add(new JLabel("12:00P.M."));
		panel_label.add(new JLabel("13:00P.M."));panel_label.add(new JLabel("14:00P.M."));panel_label.add(new JLabel("15:00P.M."));panel_label.add(new JLabel("16:00P.M."));panel_label.add(new JLabel("17:00P.M."));panel_label.add(new JLabel("18:00P.M."));
		buttonList1 = new ArrayList<JButton>();panel1 = new JPanel();panel1.setLayout(new GridLayout(12,1));panel1.add(new JLabel("          Sun"));
		buttonList2 = new ArrayList<JButton>();panel2 = new JPanel();panel2.setLayout(new GridLayout(12,1));panel2.add(new JLabel("         Mon"));
		buttonList3 = new ArrayList<JButton>();panel3 = new JPanel();panel3.setLayout(new GridLayout(12,1));panel3.add(new JLabel("         Tue"));
		buttonList4 = new ArrayList<JButton>();panel4 = new JPanel();panel4.setLayout(new GridLayout(12,1));panel4.add(new JLabel("          Wed"));
		buttonList5 = new ArrayList<JButton>();panel5 = new JPanel();panel5.setLayout(new GridLayout(12,1));panel5.add(new JLabel("          Thu"));
		buttonList6 = new ArrayList<JButton>();panel6 = new JPanel();panel6.setLayout(new GridLayout(12,1));panel6.add(new JLabel("          Fri"));
		buttonList7 = new ArrayList<JButton>();panel7 = new JPanel();panel7.setLayout(new GridLayout(12,1));panel7.add(new JLabel("          Sat"));
